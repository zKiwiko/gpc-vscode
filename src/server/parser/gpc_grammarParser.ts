...
export class gpc_grammarParser extends Parser {
	...
	public static readonly ruleNames: string[] = [
		"program", "global_statement", "statement", "import_statement", "combo_dec", 
		"break_statement", "continue_statement", "enum_dec", "enum_value", "assignment_statement", 
		"expression_statement", "switch_statement", "case_block", "if_statement", 
		"else_statement", "while_statement", "for_statement", "for_init", "for_update", 
		"do_while_statement", "return_statement", "init_dec", "main_dec", "block", 
		"function_dec", "parameter_list", "parameter", "variable_dec", "variable_declarator", 
		"array_dec", "array_body", "array_row", "expression", "primaryExpression", 
		"function_call", "expressionSuffix", "assignment", "types",
	];

	private static readonly _LITERAL_NAMES: Array<string | undefined> = [
		undefined, "'use'", "'local'", "'::'", "';'", "'combo'", "'{'", "'}'", 
		"'break'", "'continue'", "'enum'", "','", "'='", "'switch'", "'('", "')'", 
		"'case'", "':'", "'default'", "'if'", "'else'", "'while'", "'for'", "'do'", 
		"'return'", "'init'", "'main'", "'function'", "'int'", "'define'", "'['", 
		"']'", "'const'", "'[]'", "'-'", "'!'", "'+'", "'*'", "'/'", "'%'", "'=='", 
		"'!='", "'<'", "'>'", "'<='", "'>='", "'&&'", "'||'", "'|'", "'&'", "'^'", 
		"'<<'", "'>>'", "'++'", "'--'", "'+='", "'-='", "'*='", "'/='", "'%='", 
	...
	private static readonly _SYMBOLIC_NAMES: Array<string | undefined> = [
		...
		"LINE_COMMENT", "ID", "NUMBER", "STRING", "BOOLEAN",
	];
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(gpc_grammarParser._LITERAL_NAMES, gpc_grammarParser._SYMBOLIC_NAMES, []);
	...
	// @Override
	public get grammarFileName(): string { return "gpc_grammar.g4"; }

	// @Override
	public get ruleNames(): string[] { return gpc_grammarParser.ruleNames; }

	// @Override
	public get serializedATN(): string { return gpc_grammarParser._serializedATN; }
	...
	public program(): ProgramContext {
		...
		try {
			...
			while (((((_la - 1)) & ~0x1F) === 0 && ((1 << (_la - 1)) & ((1 << (gpc_grammarParser.T__0 - 1)) | (1 << (gpc_grammarParser.T__4 - 1)) | (1 << (gpc_grammarParser.T__9 - 1)) | (1 << (gpc_grammarParser.T__24 - 1)) | (1 << (gpc_grammarParser.T__25 - 1)) | (1 << (gpc_grammarParser.T__26 - 1)) | (1 << (gpc_grammarParser.T__27 - 1)) | (1 << (gpc_grammarParser.T__28 - 1)) | (1 << (gpc_grammarParser.T__31 - 1)))) !== 0)) {
				{
				{
				this.state = 76;
	...
	public combo_dec(): Combo_decContext {
		let _localctx: Combo_decContext = new Combo_decContext(this._ctx, this.state);
	...
	public enum_value(): Enum_valueContext {
		let _localctx: Enum_valueContext = new Enum_valueContext(this._ctx, this.state);
	...
	public switch_statement(): Switch_statementContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while (_la === gpc_grammarParser.T__15 || _la === gpc_grammarParser.T__17) {
				{
				{
				this.state = 177;
				this.case_block();
	...
	public for_statement(): For_statementContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (((((_la - 14)) & ~0x1F) === 0 && ((1 << (_la - 14)) & ((1 << (gpc_grammarParser.T__13 - 14)) | (1 << (gpc_grammarParser.T__33 - 14)) | (1 << (gpc_grammarParser.T__34 - 14)))) !== 0) || ((((_la - 53)) & ~0x1F) === 0 && ((1 << (_la - 53)) & ((1 << (gpc_grammarParser.T__52 - 53)) | (1 << (gpc_grammarParser.T__53 - 53)) | (1 << (gpc_grammarParser.ID - 53)) | (1 << (gpc_grammarParser.NUMBER - 53)) | (1 << (gpc_grammarParser.STRING - 53)) | (1 << (gpc_grammarParser.BOOLEAN - 53)))) !== 0)) {
				{
				this.state = 238;
				this.for_init();
				}
	...
	public for_update(): For_updateContext {
		let _localctx: For_updateContext = new For_updateContext(this._ctx, this.state);
	...
	public function_dec(): Function_decContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (_la === gpc_grammarParser.T__27 || ((((_la - 60)) & ~0x1F) === 0 && ((1 << (_la - 60)) & ((1 << (gpc_grammarParser.T__59 - 60)) | (1 << (gpc_grammarParser.T__60 - 60)) | (1 << (gpc_grammarParser.T__61 - 60)) | (1 << (gpc_grammarParser.T__62 - 60)) | (1 << (gpc_grammarParser.T__63 - 60)) | (1 << (gpc_grammarParser.T__64 - 60)) | (1 << (gpc_grammarParser.T__65 - 60)) | (1 << (gpc_grammarParser.T__66 - 60)) | (1 << (gpc_grammarParser.ID - 60)))) !== 0)) {
				{
				this.state = 325;
				this.parameter_list();
				}
	...
	public variable_dec(): Variable_decContext {
		let _localctx: Variable_decContext = new Variable_decContext(this._ctx, this.state);
	...
	public array_dec(): Array_decContext {
		let _localctx: Array_decContext = new Array_decContext(this._ctx, this.state);
	...
	public array_body(): Array_bodyContext {
		let _localctx: Array_bodyContext = new Array_bodyContext(this._ctx, this.state);
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (((((_la - 6)) & ~0x1F) === 0 && ((1 << (_la - 6)) & ((1 << (gpc_grammarParser.T__5 - 6)) | (1 << (gpc_grammarParser.T__13 - 6)) | (1 << (gpc_grammarParser.T__33 - 6)) | (1 << (gpc_grammarParser.T__34 - 6)))) !== 0) || ((((_la - 53)) & ~0x1F) === 0 && ((1 << (_la - 53)) & ((1 << (gpc_grammarParser.T__52 - 53)) | (1 << (gpc_grammarParser.T__53 - 53)) | (1 << (gpc_grammarParser.ID - 53)) | (1 << (gpc_grammarParser.NUMBER - 53)) | (1 << (gpc_grammarParser.STRING - 53)) | (1 << (gpc_grammarParser.BOOLEAN - 53)))) !== 0)) {
				{
				this.state = 404;
				this.array_row();
				this.state = 409;
	...
	public array_row(): Array_rowContext {
		let _localctx: Array_rowContext = new Array_rowContext(this._ctx, this.state);
	...
	public expressionSuffix(): ExpressionSuffixContext {
		let _localctx: ExpressionSuffixContext = new ExpressionSuffixContext(this._ctx, this.state);
		...
		try {
			...
			case gpc_grammarParser.T__38:
				...
				this.state = 477;
				_la = this._input.LA(1);
				if (!(((((_la - 34)) & ~0x1F) === 0 && ((1 << (_la - 34)) & ((1 << (gpc_grammarParser.T__33 - 34)) | (1 << (gpc_grammarParser.T__35 - 34)) | (1 << (gpc_grammarParser.T__36 - 34)) | (1 << (gpc_grammarParser.T__37 - 34)) | (1 << (gpc_grammarParser.T__38 - 34)))) !== 0))) {
				this._errHandler.recoverInline(this);
				} else {
					if (this._input.LA(1) === Token.EOF) {
						this.matchedEOF = true;
			...
			case gpc_grammarParser.T__44:
				...
				this.state = 479;
				_la = this._input.LA(1);
				if (!(((((_la - 40)) & ~0x1F) === 0 && ((1 << (_la - 40)) & ((1 << (gpc_grammarParser.T__39 - 40)) | (1 << (gpc_grammarParser.T__40 - 40)) | (1 << (gpc_grammarParser.T__41 - 40)) | (1 << (gpc_grammarParser.T__42 - 40)) | (1 << (gpc_grammarParser.T__43 - 40)) | (1 << (gpc_grammarParser.T__44 - 40)))) !== 0))) {
				this._errHandler.recoverInline(this);
				} else {
					if (this._input.LA(1) === Token.EOF) {
						this.matchedEOF = true;
			...
			case gpc_grammarParser.T__46:
				...
				this.state = 481;
				_la = this._input.LA(1);
				if (!(_la === gpc_grammarParser.T__45 || _la === gpc_grammarParser.T__46)) {
				this._errHandler.recoverInline(this);
				} else {
					if (this._input.LA(1) === Token.EOF) {
						this.matchedEOF = true;
			...
			case gpc_grammarParser.T__49:
				...
				this.state = 483;
				_la = this._input.LA(1);
				if (!(((((_la - 48)) & ~0x1F) === 0 && ((1 << (_la - 48)) & ((1 << (gpc_grammarParser.T__47 - 48)) | (1 << (gpc_grammarParser.T__48 - 48)) | (1 << (gpc_grammarParser.T__49 - 48)))) !== 0))) {
				this._errHandler.recoverInline(this);
				} else {
					if (this._input.LA(1) === Token.EOF) {
						this.matchedEOF = true;
			...
			case gpc_grammarParser.T__51:
				...
				this.state = 485;
				_la = this._input.LA(1);
				if (!(_la === gpc_grammarParser.T__50 || _la === gpc_grammarParser.T__51)) {
				this._errHandler.recoverInline(this);
				} else {
					if (this._input.LA(1) === Token.EOF) {
						this.matchedEOF = true;
			...
			case gpc_grammarParser.T__53:
				...
				this.state = 487;
				_la = this._input.LA(1);
				if (!(_la === gpc_grammarParser.T__52 || _la === gpc_grammarParser.T__53)) {
				this._errHandler.recoverInline(this);
				} else {
					if (this._input.LA(1) === Token.EOF) {
						this.matchedEOF = true;
	...
	public assignment(): AssignmentContext {
		...
		try {
			...
			case 1:
				...
				this.state = 502;
				_la = this._input.LA(1);
				if (!(_la === gpc_grammarParser.T__11 || ((((_la - 55)) & ~0x1F) === 0 && ((1 << (_la - 55)) & ((1 << (gpc_grammarParser.T__54 - 55)) | (1 << (gpc_grammarParser.T__55 - 55)) | (1 << (gpc_grammarParser.T__56 - 55)) | (1 << (gpc_grammarParser.T__57 - 55)) | (1 << (gpc_grammarParser.T__58 - 55)))) !== 0))) {
				this._errHandler.recoverInline(this);
				} else {
					if (this._input.LA(1) === Token.EOF) {
						this.matchedEOF = true;
	...
	public static readonly _serializedATN: string =
		...
		"\t\x03\t\x05\t\xA1\n\t\x03\n\x03\n\x03\n\x03\n\x05\n\xA7\n\n\x03\v\x03" +
		"\v\x03\v\x03\f\x03\f\x03\f\x03\r\x03\r\x03\r\x03\r\x03\r\x03\r\x07\r\xB5" +
		"\n\r\f\r\x0E\r\xB8\v\r\x03\r\x03\r\x03\x0E\x03\x0E\x03\x0E\x03\x0E\x03" +
		"\x0E\x03\x0E\x03\x0E\x03\x0E\x03\x0E\x03\x0E\x03\x0E\x03\x0E\x05\x0E\xC8" +
		"\n\x0E\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F" +
		"\x05\x0F\xD2\n\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x05" +
		"\x0F\xDA\n\x0F\x05\x0F\xDC\n\x0F\x03\x10\x03\x10\x03\x10\x03\x10\x03\x10" +
		"\x03\x10\x03\x10\x05\x10\xE5\n\x10\x03\x11\x03\x11\x03\x11\x03\x11\x03" +
		"\x11\x03\x11\x03\x11\x03\x11\x03\x12\x03\x12\x03\x12\x05\x12\xF2\n\x12" +
		"\x03\x12\x03\x12\x05\x12\xF6\n\x12\x03\x12\x03\x12\x05\x12\xFA\n\x12\x03" +
		"\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x13\x03\x13\x03\x13\x07\x13\u0104" +
		"\n\x13\f\x13\x0E\x13\u0107\v\x13\x03\x13\x03\x13\x03\x13\x07\x13\u010C" +
		"\n\x13\f\x13\x0E\x13\u010F\v\x13\x05\x13\u0111\n\x13\x03\x14\x03\x14\x03" +
		"\x14\x07\x14\u0116\n\x14\f\x14\x0E\x14\u0119\v\x14\x03\x14\x03\x14\x03" +
		"\x14\x07\x14\u011E\n\x14\f\x14\x0E\x14\u0121\v\x14\x05\x14\u0123\n\x14" +
		"\x03\x15\x03\x15\x03\x15\x03\x15\x03\x15\x03\x15\x03\x15\x03\x15\x03\x15" +
		"\x03\x15\x03\x16\x03\x16\x05\x16\u0131\n\x16\x03\x16\x03\x16\x03\x17\x03" +
		"\x17\x03\x17\x03\x17\x03\x17\x03\x18\x03\x18\x03\x18\x03\x18\x03\x18\x03" +
		"\x19\x07\x19\u0140\n\x19\f\x19\x0E\x19\u0143\v\x19\x03\x1A\x03\x1A\x03" +
		"\x1A\x03\x1A\x05\x1A\u0149\n\x1A\x03\x1A\x03\x1A\x03\x1A\x03\x1A\x03\x1A" +
		"\x03\x1B\x03\x1B\x03\x1B\x07\x1B\u0153\n\x1B\f\x1B\x0E\x1B\u0156\v\x1B" +
		"\x03\x1C\x05\x1C\u0159\n\x1C\x03\x1C\x03\x1C\x03\x1D\x03\x1D\x03\x1D\x03" +
		"\x1D\x07\x1D\u0161\n\x1D\f\x1D\x0E\x1D\u0164\v\x1D\x03\x1D\x03\x1D\x03" +
		"\x1E\x03\x1E\x03\x1E\x03\x1E\x03\x1E\x05\x1E\u016D\n\x1E\x03\x1E\x03\x1E" +
		"\x05\x1E\u0171\n\x1E\x03\x1F\x03\x1F\x03\x1F\x03\x1F\x03\x1F\x05\x1F\u0178" +
		"\n\x1F\x03\x1F\x03\x1F\x03\x1F\x03\x1F\x03\x1F\x03\x1F\x03\x1F\x03\x1F" +
		"\x03\x1F\x03\x1F\x03\x1F\x05\x1F\u0185\n\x1F\x05\x1F\u0187\n\x1F\x03\x1F" +
		"\x03\x1F\x03\x1F\x03\x1F\x03\x1F\x03\x1F\x03\x1F\x03\x1F\x03\x1F\x03\x1F" +
		"\x03\x1F\x05\x1F\u0194\n\x1F\x03 \x03 \x03 \x03 \x07 \u019A\n \f \x0E" +
		" \u019D\v \x05 \u019F\n \x03 \x03 \x03!\x03!\x03!\x03!\x03!\x07!\u01A8" +
		"\x02\u01E0\u01EB\x05B\"\x02\u01E1\u01E2\t\x04\x02\x02\u01E2\u01EB\x05" +
		"B\"\x02\u01E3\u01E4\t\x05\x02\x02\u01E4\u01EB\x05B\"\x02\u01E5\u01E6\t" +
		"\x06\x02\x02\u01E6\u01EB\x05B\"\x02\u01E7\u01E8\t\x07\x02\x02\u01E8\u01EB" +
		"\x05B\"\x02\u01E9\u01EB\t\b\x02\x02\u01EA\u01D6\x03\x02\x02\x02\u01EA" +
		"\u01DF\x03\x02\x02\x02\u01EA\u01E1\x03\x02\x02\x02\u01EA\u01E3\x03\x02" +
		"\x02\x02\u01EA\u01E5\x03\x02\x02\x02\u01EA\u01E7\x03\x02\x02\x02\u01EA" +
		"\u01E9\x03\x02\x02\x02\u01EBI\x03\x02\x02\x02\u01EC\u01F6\x07I\x02\x02" +
		"\u01ED\u01EE\x07 \x02\x02\u01EE\u01EF\x05B\"\x02\u01EF\u01F4\x07!\x02" +
		"\x02\u01F0\u01F1\x07 \x02\x02\u01F1\u01F2\x05B\"\x02\u01F2\u01F3\x07!" +
		"\x02\x02\u01F3\u01F5\x03\x02\x02\x02\u01F4\u01F0\x03\x02\x02\x02\u01F4" +
		"\u01F5\x03\x02\x02\x02\u01F5\u01F7\x03\x02\x02\x02\u01F6\u01ED\x03\x02" +
		"\x02\x02\u01F6\u01F7\x03\x02\x02\x02\u01F7\u01F8\x03\x02\x02\x02\u01F8" +
		"\u01F9\t\t\x02\x02\u01F9\u01FF\x05B\"\x02\u01FA\u01FB\x07I\x02\x02\u01FB" +
		"\u01FF\t\b\x02\x02\u01FC\u01FD\t\b\x02\x02\u01FD\u01FF\x07I\x02\x02\u01FE" +
		"\u01EC\x03\x02\x02\x02\u01FE\u01FA\x03\x02\x02\x02\u01FE\u01FC\x03\x02" +
		"\x02\x02\u01FFK\x03\x02\x02\x02\u0200\u0201\t\n\x02\x02\u0201M\x03\x02" +
		"\x02\x026Q^jov\x87\x8F\x98\x9C\xA0\xA6\xB6\xC7\xD1\xD9\xDB\xE4\xF1\xF5" +
		"\xF9\u0105\u010D\u0110\u0117\u011F\u0122\u0130\u0141\u0148\u0154\u0158" +
		"\u0162\u016C\u0170\u0177\u0184\u0186\u0193\u019B\u019E\u01A9\u01AC\u01AF" +
		"\u01B5\u01C6\u01CF\u01D2\u01DD\u01EA\u01F4\u01F6\u01FE";
	...
	public static get _ATN(): ATN {
		if (!gpc_grammarParser.__ATN) {
			gpc_grammarParser.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(gpc_grammarParser._serializedATN));
		}
...
export class ProgramContext extends ParserRuleContext {
	public EOF(): TerminalNode { return this.getToken(gpc_grammarParser.EOF, 0); }
	public global_statement(): Global_statementContext[];
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_program; }
	// @Override
...
export class Global_statementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_global_statement; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class StatementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_statement; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Import_statementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_import_statement; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Combo_decContext extends ParserRuleContext {
	public ID(): TerminalNode { return this.getToken(gpc_grammarParser.ID, 0); }
	public block(): BlockContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_combo_dec; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Break_statementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_break_statement; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Continue_statementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_continue_statement; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Enum_decContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_enum_dec; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Enum_valueContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_enum_value; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Assignment_statementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_assignment_statement; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Expression_statementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_expression_statement; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Switch_statementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_switch_statement; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Case_blockContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_case_block; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class If_statementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_if_statement; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Else_statementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_else_statement; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class While_statementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_while_statement; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class For_statementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_for_statement; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class For_initContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_for_init; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class For_updateContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_for_update; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Do_while_statementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_do_while_statement; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Return_statementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_return_statement; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Init_decContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_init_dec; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Main_decContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_main_dec; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class BlockContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_block; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Function_decContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_function_dec; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Parameter_listContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_parameter_list; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class ParameterContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_parameter; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Variable_decContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_variable_dec; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Variable_declaratorContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_variable_declarator; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Array_decContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_array_dec; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Array_bodyContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_array_body; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Array_rowContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_array_row; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class ExpressionContext extends ParserRuleContext {
	...
	public expressionSuffix(i?: number): ExpressionSuffixContext | ExpressionSuffixContext[] {
		if (i === undefined) {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_expression; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class PrimaryExpressionContext extends ParserRuleContext {
	public ID(): TerminalNode | undefined { return this.tryGetToken(gpc_grammarParser.ID, 0); }
	public NUMBER(): TerminalNode | undefined { return this.tryGetToken(gpc_grammarParser.NUMBER, 0); }
	public STRING(): TerminalNode | undefined { return this.tryGetToken(gpc_grammarParser.STRING, 0); }
	public BOOLEAN(): TerminalNode | undefined { return this.tryGetToken(gpc_grammarParser.BOOLEAN, 0); }
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_primaryExpression; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class Function_callContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_function_call; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class ExpressionSuffixContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_expressionSuffix; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class AssignmentContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_assignment; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
...
export class TypesContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return gpc_grammarParser.RULE_types; }
	// @Override
	public accept<Result>(visitor: gpc_grammarVisitor<Result>): Result {
